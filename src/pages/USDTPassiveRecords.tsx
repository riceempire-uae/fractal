...
import { ArrowLeft, List, ArrowDown, ArrowUp, FileText } from 'lucide-react';

const USDTPassiveRecordsContainer = styled.div`
  min-height: 100vh;
  background: #0b1a2b;
  color: #eef5ff;
  padding: 0;
...
interface USDTPassiveRecordsProps {
  onNavigate?: (page: string) => void;
}

const USDTPassiveRecords: React.FC<USDTPassiveRecordsProps> = ({ onNavigate }) => {
  ...
  return (
    <USDTPassiveRecordsContainer>
      <Header>
        <HeaderLeft>
          <BackButton onClick={() => onNavigate?.('passive-income-details')}>
            <ArrowLeft size={20} />
          </BackButton>
          <HeaderTitle>USDT Passive Records</HeaderTitle>
        </HeaderLeft>
      </Header>
            ...
            <TableBody>
              {filteredRecords.length > 0 ? (
                ...
                <EmptyState>
                  ...
                  <EmptyDescription>
                    Your USDT passive income records will appear here
                  </EmptyDescription>
                </EmptyState>
              )}
            </TableBody>
...
export default USDTPassiveRecords;
